...
def custom_quit(msg: str) -> None:
    """Завершение работы программы с выводом сообщения на консоль.

    :param msg: Сообщение, выводимое на консоль при выходе.
    """
...
class Translator:
    """Класс для перевода валюты из международного формата на русский язык и
    с русского языка в числовой формат по заранее установленному курсу.
    """
